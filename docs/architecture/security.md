...
chains that are checked before access is granted (managed in Katta Web; see the feature comparison in the [Concepts](../concepts.md#feature-comparison-of-katta-clients)).
